...
void information(){
	...
	SetColor(4);
	gotoxy(10,8);
	printf("moi gop y vui long gui ve hom thu 6151071001@st.utc2.edu.vn");
		gotoxy(8,9);
		printf("hoac lien he fb: https://www.facebook.com/profile.php?id=100025256469095");
		gotoxy(3,10);
...
void setting(){
  system("cls");
  gotoxy(0,9);
  printf("an cac phim left right tren ban phim de tang giam toc do, nhan enter de tro ve menu");
  gotoxy(30,11);
...
void menu(){
	...
	system("cls");
    gotoxy(25,3);
	printf("Game ran an moi cua TEAM 1");
	gotoxy(30,5);
	SetColor(4);
	printf("1. vao game");
	gotoxy(30,6);
